<template>
	<div
		class="match-detail-page container page-container"
		v-loading="loading"
	>
		<template v-if="match">
			<div class="detail-main">
				...
				>
					<h3>场馆信息</h3>
					<div
						class="venue-card-detail"
						@click="$router.push(`/venues/${match.venueId}`)"
					>
			...
			<div class="detail-sidebar">
				<div class="sidebar-card">
					...
					<div class="player-count">已报名 {{ match.currentPlayers }}/{{ match.maxPlayers }} 人</div>
					<el-progress
					...
					>
						<template v-if="match.creatorId === userStore.user?.id">
							<el-button
								...
								plain
								@click="handleCancel"
								:disabled="![1, 2].includes(match.status)"
							>
								取消球局
							</el-button>
							<el-button
