...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'matches', name: 'MyMatches', component: () => import('@/views/user/MyMatches.vue'), meta: { title: '我的球局' } },
      ...
      { path: 'credit', name: 'Credit', component: () => import('@/views/user/Credit.vue'), meta: { title: '信用记录' } },
    ],
  },
  {
    path: '/login',
