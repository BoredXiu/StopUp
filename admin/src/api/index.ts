...
export const adminApi = {
  ...
  updateUserStatus: (id: number, status: number) =>
    service.put(`/admin/users/${id}/status`, { status }),
  getMatches: (params?: any) => service.get('/admin/matches', { params }),
  updateMatchStatus: (id: number, data: any) =>
    service.put(`/admin/matches/${id}/status`, data),
  ...
  handleReport: (id: number, data: any) =>
    service.put(`/admin/reports/${id}/handle`, data),
}