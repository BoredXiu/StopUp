	...
	<view class="page">
		<view class="form-card">
			...
			<view class="form-group">
				...
				<textarea class="form-textarea" v-model="form.description" placeholder="补充一些场局信息..." maxlength="1000" />
			</view>

			<button class="submit-btn" @tap="handleSubmit" :loading="submitting">创建场局</button>
		</view>
	</view>
</template>
...
function onFeeTypeChange(e: any): void {
	form.feeType = (e.detail.value as number) + 1
}
