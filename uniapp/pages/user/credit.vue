<template>
  <view class="page">
    <view class="credit-card">
      ...
      <text class="credit-value" :class="scoreClass">{{ userStore.user?.creditScore || 0 }}</text>
...
.rules-title { font-size: 15px; font-weight: 600; display: block; margin-bottom: 10px; }
.rule-item { display: block; font-size: 13px; padding: 4px 0; color: #666; }

.log-section { background: #fff; border-radius: 12px; padding: 16px; }
.section-title { font-size: 15px; font-weight: 600; display: block; margin-bottom: 12px; }
.log-item {
  display: flex;
...
.log-reason { font-size: 14px; display: block; }
.log-time { font-size: 12px; color: #999; }
.log-amount { font-size: 18px; font-weight: 700; }
